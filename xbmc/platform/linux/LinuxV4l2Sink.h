...
public:
  ...
  /// note: 
  /// for V4L2_BUF_TYPE_VIDEO_CAPTURE_MPLANE, a negative value
  /// an be passed as buffersCount. this means that 
  /// "min buffers for capture" + abs(buffersCount) buffers will
  /// be allocated.  
